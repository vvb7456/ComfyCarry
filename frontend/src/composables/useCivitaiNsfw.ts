...
const browsingLevel = ref<number>(7) // 默认 PG–R (PG + PG13 + R), civitai 默认档
...
export function useCivitaiNsfw() {
  ...
  return {
    browsingLevel: readonly(browsingLevel),
    blur: readonly(blurNsfw),
    loaded,
    load,
    save,
    levelAllows,
